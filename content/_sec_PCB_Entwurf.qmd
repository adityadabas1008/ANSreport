...
4. **Platzoptimierung**  
   ...
   ![PCB-Design Version 1](images/pcbv1.png){#fig-pcbv1 fig-align="left" width=60%}

---

### Design-Verbesserungen und Begründungen {.unnumbered}

1. **Bauteiwertebeschriftung**  
...
![Fertiges PCB-Design](images/pcbv2.png){#fig:pcbv2 width=90%}

![Fertige PCB](images/platine.jpg){#fig:pcb width=90%}
...
- Einheitliche Testpoints für Ein-/Ausgang und GND  
